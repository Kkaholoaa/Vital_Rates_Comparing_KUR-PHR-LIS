...
# Separating the growth data frame by genera #
POCS_g <- Growth[Growth$Genus_Code==GeneraNames[1],]
POSP_g <- Growth[Growth$Genus_Code==GeneraNames[2],]
MOSP_g <- Growth[Growth$Genus_Code==GeneraNames[3],]

##############
#SURVIVAL
# subsetting the survival data frame by genera 
POCS_s <- surv_dat[surv_dat$Genus_Code==GeneraNames[1],]
POSP_s <- surv_dat[surv_dat$Genus_Code==GeneraNames[2],]
MOSP_s <- surv_dat[surv_dat$Genus_Code==GeneraNames[3],]
