...
abline(a=Glist_site$g.int[1], b=Glist_site$g.slp[1], col=1:12, lwd=2)
abline(a=Glist_site$g.int[2], b=Glist_site$g.slp[2], col=2:12, lwd=2)
abline(a=Glist_site$g.int[3], b=Glist_site$g.slp[3], col=3:12, lwd=2)
abline(a=Glist_site$g.int[4], b=Glist_site$g.slp[4], col=4:12, lwd=2)
abline(a=Glist_site$g.int[5], b=Glist_site$g.slp[5], col=5:12, lwd=2)
abline(a=Glist_site$g.int[6], b=Glist_site$g.slp[6], col=6:12, lwd=2)
abline(a=Glist_site$g.int[7], b=Glist_site$g.slp[7], col=7:12, lwd=2)
abline(a=Glist_site$g.int[8], b=Glist_site$g.slp[8], col=8:12, lwd=2)
abline(a=Glist_site$g.int[9], b=Glist_site$g.slp[9], col=9:12, lwd=2)
abline(a=Glist_site$g.int[10], b=Glist_site$g.slp[10], col=10:12, lwd=2)
abline(a=Glist_site$g.int[11], b=Glist_site$g.slp[11], col=11:12, lwd=2)
...
par(mfrow=c(2,2))
#MAISIOK01
plot(ln_ES ~ ln_SS ,data = ColonyLevel, main="MAISIOK01 growth fit for all genera + all interval years")
abline(a=Glist_site$g.int[1], b=Glist_site$g.slp[1], col=1:11, lwd=2)
legend("topleft", bty = "n", lty = c(1,1), col = 1:11,
       legend= 'MAISIOK01' , cex = 0.8)
#HAWOCC002
plot(ln_ES ~ ln_SS ,data = ColonyLevel, main="HAWOCC002 growth fit for all genera + all interval years")
abline(a=Glist_site$g.int[2], b=Glist_site$g.slp[2], col=2:11, lwd=2)
legend("topleft", bty = "n", lty = c(1,1), col = 2:11,
       legend= 'HAWOCC002' , cex = 0.8)
#HAWOCC003
plot(ln_ES ~ ln_SS ,data = ColonyLevel, main="HAWOCC003 growth fit for all genera + all interval years")
abline(a=Glist_site$g.int[3], b=Glist_site$g.slp[3], col=3:11, lwd=2)
legend("topleft", bty = "n", lty = c(1,1), col = 3:11,
       legend= 'HAWOCC003' , cex = 0.8)
#HAWOCC010
plot(ln_ES ~ ln_SS ,data = ColonyLevel, main="HAWOCC010 growth fit for all genera + all interval years")
abline(a=Glist_site$g.int[4], b=Glist_site$g.slp[4], col=4:11, lwd=2)
legend("topleft", bty = "n", lty = c(1,1), col = 4:11,
       legend= 'HAWOCC010' , cex = 0.8)
#etc. Should I keep plotting these?
