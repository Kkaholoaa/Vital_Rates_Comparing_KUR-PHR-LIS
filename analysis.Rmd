...
### Survival
```{r 1 FULLmod Survival, eval=FALSE}
################################################################################
...
```
```{r 2 GeneraMod Survival,eval=FALSE}
################################################################################
...
```
```{r 3 SiteMod Survival,eval=FALSE}
################################################################################
...
```
```{r 4 YearMod Survival,eval=FALSE}
################################################################################
...
## Getting the error: "glm.fit: algorithm did not converge" might need to start this loop with a new dataframe for the survival data? 
```
```{r 5 Genera + Site Mod Survival,eval=FALSE}
################################################################################
...
```
```{r 6 Genera + Years Mod Survival,eval=FALSE}
################################################################################
######### Genera + Interval Years for all Site models ##########################
################################################################################
...
```
```{r 7 Site + Years Mod Survival,eval=FALSE}
################################################################################
######### Site + Interval Years for all Genera models ##########################
################################################################################
...
```
```{r 8 Genera + Site + Years Mod Survival,eval=FALSE}
################################################################################
######### Genera + Site + Interval Years  models ###############################
## SURVIVAL ! ##################################################################
################################################################################
...
```{r Plotting full growth model 1,eval=FALSE }
...
```{r Plotting full growth model 2,eval=FALSE}
