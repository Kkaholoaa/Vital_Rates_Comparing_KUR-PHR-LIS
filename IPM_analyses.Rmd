...
POCS <- combo[combo$Genus_Code == "POCS",]
drop_i <- which(POCS$GModel.n < 3)
if(length(drop_i)> 0 ) POCS=POCS[-drop_i,]

MOSP <- combo[combo$Genus_Code == "MOSP",]
POSP <- combo[combo$Genus_Code == "POSP",]
