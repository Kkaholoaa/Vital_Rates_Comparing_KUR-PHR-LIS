...
# #No 2015
# recvalpc <- 35.75 #34.169  #excl 2015 #28.55 incl all intervals
# recvalpp <- 29.1  #26.259  #excl 2015#24.85 incl all intervals
# recvalmp <- 31.35 #30.13  #excl 2015 #25.25 incl all intervals
# # 
# #Yes 2015
# recvalpc <- 36.07 #34.169  #excl 2015 #28.55 incl all intervals
# recvalpp <- 34.20 #26.259  #excl 2015#24.85 incl all intervals
# recvalmp <- 32.65 #30.13  #excl 2015 #25.25 incl all intervals

#All Interval
recvalpc <- 35.53  #excl 2015 #28.55 incl all intervals
recvalpp <- 30.61  #excl 2015#24.85 incl all intervals
recvalmp <- 31.74  #excl 2015 #25.25 incl all intervals
...
######
#Tom Ran this with all Intervals, set to No2015 Recruitment
######
...
Name <- "AllInterval_RecruitTunedAll_"
...
#POCS
png(filename = "figs/AllInt_POCS_fullK.png")
...
png(filename = "figs/AllInt_MOSP_alternatefullK.png")
...
#Plot Elasticity
png(filename = "figs/AllInt_POCS_elasticity.png")
...
#Plot Sensitivity
png(filename = "figs/AllInt_POCS_sensitivity.png")
...
#POSP
png(filename = "figs/AllInt_POSP_fullK.png")
...
#MOSP
png(filename = "figs/AllInt_MOSP_fullK.png")
