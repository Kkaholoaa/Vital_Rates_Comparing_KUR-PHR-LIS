...
fit_POCS
summary(fit_POCS)
plot(ln_ES ~ ln_SS ,data = growth_POCS ,xlim=c(-3,10), ylim=c(-3,10) )  #the final index of the ln_ES aka the largest size
abline(fit_POCS)
abline(a=0, b=1,col="red")
#everyone's growing and smaller sizes grow supa faster and the larger sizes are right at the 1:1
coef(fit_POCS) #get the slope and transition
#linear model for growth function
...
#y = 0.8462x + 1.0236
summary(fit_POSP)
plot(ln_ES ~ ln_SS ,data = growth_POSP ,xlim=c(-3,10), ylim=c(-3,10) )  #the final index of the ln_ES aka the largest size
abline(fit_POSP)
abline(a=0, b=1,col="red")
#smaller sizes grow faster and the larger sizes are right at the 1:1
...
#y = 0.8559x + 0.9507
summary(fit_MOSP)
plot(ln_ES ~ ln_SS ,data = growth_MOSP ,xlim=c(-3,10), ylim=c(-3,10), xlab )  #the final index of the ln_ES aka the largest size
abline(fit_MOSP)
abline(a=0, b=1,col="red")
#smaller sizes grow faster and the larger sizes are right at the 1:1
...
Next separate by site, all genera
